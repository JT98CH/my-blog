...
Now, what about the title length? I wonder if there's a relationship or something interesting about it.
</pre>
  </code>
...
The graph shows that it follows a normal distribution, I will consider that as interesting
