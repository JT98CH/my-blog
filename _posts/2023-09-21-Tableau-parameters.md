...
* Open Tableau. On the start page, under Connect, click More. In the Open dialog box, navigate to the CSV file in your local computer. For this example, I'm using the Employee data from [Kaggle](https://help.tableau.com/current/pro/desktop/en-us/getstarted_buildmanual_ex1basic.htm){:targe="https://www.kaggle.com/datasets/prakharjadaun/employee-data?rvi=1"}
